...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='configs/yolov5s.yaml', help='source')  
    parser.add_argument('--weights',type=str, default='weights/yolov5s.pkl', help='model.pt path(s)')
